...
CREATE INDEX IF NOT EXISTS idx_campaigns_campaign_token ON campaigns(campaign_token);
CREATE INDEX IF NOT EXISTS idx_campaigns_buyer_id ON campaigns(buyer_id);
