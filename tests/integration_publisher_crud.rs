...
// Note: sqlx::test macro requires sqlx to be compiled with "runtime-tokio-native-tls" and "postgres" features
// and DATABASE_URL environment variable to be set
#[sqlx::test(migrations = "../migrations")]
async fn test_create_publisher(pool: PgPool) -> sqlx::Result<()> {
...
#[sqlx::test]
async fn test_list_publishers(pool: PgPool) -> sqlx::Result<()> {
...
#[sqlx::test]
async fn test_update_publisher(pool: PgPool) -> sqlx::Result<()> {
...
#[sqlx::test]
async fn test_publisher_email_uniqueness_for_active(pool: PgPool) -> sqlx::Result<()> {
...
#[sqlx::test]
async fn test_deleted_publisher_email_reuse(pool: PgPool) -> sqlx::Result<()> {
